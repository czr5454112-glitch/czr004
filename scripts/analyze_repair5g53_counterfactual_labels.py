"""Analyze Repair5G.5.3 counterfactual UpdateLTM label quality."""
...
DEFAULT_REPORT = "outputs/reports/phase5p5_repair5g53_counterfactual_label_quality_report.md"
DEFAULT_SUMMARY = "outputs/reports/phase5p5_repair5g53_counterfactual_label_quality_summary.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = {
        "schema_version": "phase5p5_repair5g53_counterfactual_label_quality_summary_v1",
        "context_count": len(contexts),
        "label_rows": len(labels),
        "available_label_rows": len(available),
        "oracle_rows": len(oracle),
        "gates": gates,
        "decision": "counterfactual_labels_available_continue_g6_design" if gates["counterfactual_label_quality_passed"] else "counterfactual_labels_unavailable",
    ...
    write_text(
        ...
        "# Phase5.5 Repair5G.5.3 Counterfactual Label Quality\n\n"
