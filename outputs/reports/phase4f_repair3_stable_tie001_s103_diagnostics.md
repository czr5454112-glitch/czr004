...
- offline eval CSV: `outputs/tables/phase4f_repair3_stable_tie001_s103_eval_h010.csv`
- offline eval summary: `outputs/reports/phase4f_repair3_stable_tie001_s103_eval_h010_summary.json`
- dataset rows: `2985`
- probe rows: `24216`
- eval rows: `2985`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| train | 2526 | 0.5087 | 0.8464 | 0.5178 | 0.9960 | 0.5241 | 0.0292 |
| validation | 459 | 0.3943 | 0.7538 | 0.4031 | 0.9711 | 0.3934 | -0.0010 |
| all | 2985 | 0.4911 | 0.8322 | 0.5002 | 0.9930 | 0.5043 | 0.0246 |
...
| block_heavy | neutral_additive | block | additive_or_neutral | 39 |
| neutral_additive | commit_heavy | additive_or_neutral | commit | 38 |
| wait_light | neutral_additive | wait | additive_or_neutral | 21 |
| neutral_additive | block_heavy | additive_or_neutral | block | 20 |
| block_heavy | commit_heavy | block | commit | 13 |
| commit_heavy | block_heavy | commit | block | 11 |
| wait_light | block_heavy | wait | block | 11 |
| decay_095 | neutral_additive | decay | additive_or_neutral | 9 |
...
- Train-calibrated candidate meeting recall >= 0.80 and precision >= 0.30: threshold `0.40`, recall `0.8309`, precision `0.6488`, fallback rate `0.6358`, mean delta after fallback `0.0095`.
- Validation diagnostic candidate meeting recall >= 0.80 and precision >= 0.30: threshold `0.25`, recall `0.8671`, precision `0.4478`, fallback rate `0.7298`, mean delta after fallback `0.0035`.
...
- label margin details: `outputs/tables/phase4f_repair3_stable_tie001_s103_diagnostics/phase4f_laur_label_margin_details.csv`
- label margin histogram: `outputs/tables/phase4f_repair3_stable_tie001_s103_diagnostics/phase4f_laur_label_margin_histogram.csv`
- per-map confusion: `outputs/tables/phase4f_repair3_stable_tie001_s103_diagnostics/phase4f_laur_per_map_confusion.csv`
- safety threshold sweep: `outputs/tables/phase4f_repair3_stable_tie001_s103_diagnostics/phase4f_laur_safety_threshold_sweep.csv`
- feature drift: `outputs/tables/phase4f_repair3_stable_tie001_s103_diagnostics/phase4f_laur_feature_drift.csv`
