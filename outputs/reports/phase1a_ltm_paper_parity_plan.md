...
Scenario source: `outputs/tmp/phase1a/generated/phase1a-generated-random.zip`, generated by `scripts/generate_phase1a_scenarios.py --overwrite` and extracted by the run script into `outputs/tmp/phase1a/scen/`.
